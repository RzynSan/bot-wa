...
text: `🚩 Hai Kak? Bot Di Mode Group Only, Ingin Bebas Akses Ke PrivateChat Bot? Silahkan Buy Premium, https://wa.me/${nomorown}?text=Halo+Kak+Mau+Beli+Premium+Bot

Ingin Free Akses? Silahkan Gabung Ke Group Bot Agar Dapat Info Lebih Lanjut`,
contextInfo: {
mentionedJid: [m.sender, nomorown],
externalAdReply: { showAdAttribution: true, 
title: `Akses PrivateChat Di tolak,`,
...
renderLargerThumbnail: true 
  ...
  async onCall(json) {
    ...
    if (jid && isOffer) {
      ...
      m.reply(`Kamu dibanned karena menelepon bot!!`)
    }
  },
...
global.dfail = (type, m, conn) => {
    ...
    let msg = {
    rowner: Func.Styles('Maaf, arahan ini hanya boleh digunakan oleh *Developer* 🍪.'),
    owner: Func.Styles('Maaf, arahan ini hanya boleh digunakan oleh *Owner* 🍯.'),
    mods: Func.Styles('Maaf, arahan ini hanya boleh digunakan oleh *Moderator* 🥧.'),
    premium: Func.Styles('Maaf, arahan ini hanya untuk *pengguna premium* 🍪.'),
    group: Func.Styles('Maaf, arahan ini hanya boleh digunakan dalam *Group* 🍯.'),
    vip: Func.Styles('Maaf, arahan ini hanya untuk *Pengguna VIP* 🥧.'),
    private: Func.Styles('Maaf, arahan ini hanya boleh digunakan dalam *Chat Private* 🍪.'),
    admin: Func.Styles('Maaf, arahan ini hanya untuk *Admin* 🍯.'),
    botAdmin: Func.Styles('Jadikan *Bot* sebagai *Admin* 🥧 untuk menggunakan arahan ini.'),
    restrict: Func.Styles('Ciri ini telah *dinonaktifkan* 🍪.')
}[type]
